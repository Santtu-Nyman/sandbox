...
def find_master_server():
    ...
    if len(message) < 8 or message[0] != 1 or message[1] != 7 :
        return { "system_status" : 255, "master_device_id" : 255, "map_height" : 0, "map_width" : 0, "master_device_address" : "0.0.0.0", "map" : [], "block_list" : [], "device_list" : [] }
    ...
    if (8 + map_size + block_list_size + device_list_size) != len(message) :
        return { "system_status" : 255, "master_device_id" : 255, "map_height" : 0, "map_width" : 0, "master_device_address" : "0.0.0.0", "map" : [], "block_list" : [], "device_list" : [] }
    
    configuration = { "system_status" : system_status, "master_device_id" : master_id, "map_height" : map_height, "map_width" : map_width, "master_device_address" : str(master_address[0]), "map" : [], "block_list" : [], "device_list" : [] }
